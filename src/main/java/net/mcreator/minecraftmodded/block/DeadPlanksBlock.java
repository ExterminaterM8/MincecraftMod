...
public class DeadPlanksBlock extends MinecraftmoddedModElements.ModElement {
	@ObjectHolder("minecraftmodded:dead_planks")
	public static final Block block = null;
	public DeadPlanksBlock(MinecraftmoddedModElements instance) {
		super(instance, 85);
	}
