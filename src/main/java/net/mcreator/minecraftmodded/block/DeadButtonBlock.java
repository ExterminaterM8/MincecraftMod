...
public class DeadButtonBlock extends MinecraftmoddedModElements.ModElement {
	@ObjectHolder("minecraftmodded:dead_button")
	public static final Block block = null;
	public DeadButtonBlock(MinecraftmoddedModElements instance) {
		super(instance, 92);
	}
