...
public class DeadLogBlock extends MinecraftmoddedModElements.ModElement {
	@ObjectHolder("minecraftmodded:dead_log")
	public static final Block block = null;
	public DeadLogBlock(MinecraftmoddedModElements instance) {
		super(instance, 84);
	}
