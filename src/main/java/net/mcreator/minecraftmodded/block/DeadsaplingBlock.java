...
public class DeadsaplingBlock extends MinecraftmoddedModElements.ModElement {
	@ObjectHolder("minecraftmodded:deadsapling")
	public static final Block block = null;
	public DeadsaplingBlock(MinecraftmoddedModElements instance) {
		super(instance, 103);
