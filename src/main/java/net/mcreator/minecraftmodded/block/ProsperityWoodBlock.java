...
public class ProsperityWoodBlock extends MinecraftmoddedModElements.ModElement {
	@ObjectHolder("minecraftmodded:prosperity_wood")
	public static final Block block = null;
	public ProsperityWoodBlock(MinecraftmoddedModElements instance) {
		super(instance, 106);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(2.6f, 2.467088208142348f).setLightLevel(s -> 0)
					.harvestLevel(0).harvestTool(ToolType.AXE).setRequiresTool());
			this.setDefaultState(this.stateContainer.getBaseState().with(AXIS, Direction.Axis.Y));
			setRegistryName("prosperity_wood");
		}
