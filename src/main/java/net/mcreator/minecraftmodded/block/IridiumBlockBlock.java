...
public class IridiumBlockBlock extends MinecraftmoddedModElements.ModElement {
	@ObjectHolder("minecraftmodded:iridium_block")
	public static final Block block = null;
	public IridiumBlockBlock(MinecraftmoddedModElements instance) {
		super(instance, 60);
	}
