...
public class EmptyCasingItem extends MinecraftmoddedModElements.ModElement {
	@ObjectHolder("minecraftmodded:empty_casing")
	public static final Item block = null;
	public EmptyCasingItem(MinecraftmoddedModElements instance) {
		super(instance, 57);
	}
