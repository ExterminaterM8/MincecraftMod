...
public class DeadSlabBlock extends MinecraftmoddedModElements.ModElement {
	@ObjectHolder("minecraftmodded:dead_slab")
	public static final Block block = null;
	public DeadSlabBlock(MinecraftmoddedModElements instance) {
		super(instance, 88);
	}
