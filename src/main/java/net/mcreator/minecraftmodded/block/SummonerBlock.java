...
import net.mcreator.minecraftmodded.procedures.SummonerRedstoneOnProcedure;
...
public class SummonerBlock extends MinecraftmoddedModElements.ModElement {
	@ObjectHolder("minecraftmodded:summoner")
	public static final Block block = null;
	public SummonerBlock(MinecraftmoddedModElements instance) {
		super(instance, 37);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				SummonerRedstoneOnProcedure.executeProcedure($_dependencies);
			}
