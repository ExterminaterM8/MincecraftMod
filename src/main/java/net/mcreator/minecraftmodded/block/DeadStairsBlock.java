...
public class DeadStairsBlock extends MinecraftmoddedModElements.ModElement {
	@ObjectHolder("minecraftmodded:dead_stairs")
	public static final Block block = null;
	public DeadStairsBlock(MinecraftmoddedModElements instance) {
		super(instance, 87);
	}
