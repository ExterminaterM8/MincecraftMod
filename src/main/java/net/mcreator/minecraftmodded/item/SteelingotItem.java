...
public class SteelingotItem extends MinecraftmoddedModElements.ModElement {
	@ObjectHolder("minecraftmodded:steelingot")
	public static final Item block = null;
	public SteelingotItem(MinecraftmoddedModElements instance) {
		super(instance, 64);
	}
