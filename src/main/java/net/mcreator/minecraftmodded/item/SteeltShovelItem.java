...
public class SteeltShovelItem extends MinecraftmoddedModElements.ModElement {
	@ObjectHolder("minecraftmodded:steelt_shovel")
	public static final Item block = null;
	public SteeltShovelItem(MinecraftmoddedModElements instance) {
		super(instance, 76);
	}
