...
public class DeadLeavesBlock extends MinecraftmoddedModElements.ModElement {
	@ObjectHolder("minecraftmodded:dead_leaves")
	public static final Block block = null;
	public DeadLeavesBlock(MinecraftmoddedModElements instance) {
		super(instance, 86);
	}
