...
import net.mcreator.minecraftmodded.entity.renderer.SpearRenderer;
import net.mcreator.minecraftmodded.MinecraftmoddedModElements;

import java.util.Random;

@MinecraftmoddedModElements.ModElement.Tag
public class SpearItem extends MinecraftmoddedModElements.ModElement {
	@ObjectHolder("minecraftmodded:spear")
	...
	public SpearItem(MinecraftmoddedModElements instance) {
		super(instance, 105);
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(AidensStuffItemGroup.tab).maxDamage(100));
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(BrightswordItem.block);
		}
