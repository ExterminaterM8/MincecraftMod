...
public class DeadFenceBlock extends MinecraftmoddedModElements.ModElement {
	@ObjectHolder("minecraftmodded:dead_fence")
	public static final Block block = null;
	public DeadFenceBlock(MinecraftmoddedModElements instance) {
		super(instance, 89);
	}
