...
public class ProsperityButtonBlock extends MinecraftmoddedModElements.ModElement {
	@ObjectHolder("minecraftmodded:prosperity_button")
	public static final Block block = null;
	public ProsperityButtonBlock(MinecraftmoddedModElements instance) {
		super(instance, 115);
	}
	...
	public static class CustomBlock extends WoodButtonBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(2.6f, 3.9000000000000004f)
					.setLightLevel(s -> 0));
			setRegistryName("prosperity_button");
		}
