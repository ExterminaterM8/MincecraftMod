...
public class IridiumOreBlock extends MinecraftmoddedModElements.ModElement {
	@ObjectHolder("minecraftmodded:iridium_ore")
	public static final Block block = null;
	public IridiumOreBlock(MinecraftmoddedModElements instance) {
		super(instance, 59);
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(IridiumIngotItem.block));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("minecraftmodded:iridium_ore_match"),
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("minecraftmodded:iridium_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
