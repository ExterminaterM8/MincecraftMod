...
public class DeadWoodBlock extends MinecraftmoddedModElements.ModElement {
	@ObjectHolder("minecraftmodded:dead_wood")
	public static final Block block = null;
	public DeadWoodBlock(MinecraftmoddedModElements instance) {
		super(instance, 83);
	}
