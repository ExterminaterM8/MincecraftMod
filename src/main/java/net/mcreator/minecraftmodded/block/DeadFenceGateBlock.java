...
public class DeadFenceGateBlock extends MinecraftmoddedModElements.ModElement {
	@ObjectHolder("minecraftmodded:dead_fence_gate")
	public static final Block block = null;
	public DeadFenceGateBlock(MinecraftmoddedModElements instance) {
		super(instance, 90);
	}
