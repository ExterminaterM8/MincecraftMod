...
public class ProsperityFenceBlock extends MinecraftmoddedModElements.ModElement {
	@ObjectHolder("minecraftmodded:prosperity_fence")
	public static final Block block = null;
	public ProsperityFenceBlock(MinecraftmoddedModElements instance) {
		super(instance, 112);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(2.6f, 3.9000000000000004f)
					.setLightLevel(s -> 0));
			setRegistryName("prosperity_fence");
		}
