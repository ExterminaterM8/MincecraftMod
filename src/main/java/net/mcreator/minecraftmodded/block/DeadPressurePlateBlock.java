...
public class DeadPressurePlateBlock extends MinecraftmoddedModElements.ModElement {
	@ObjectHolder("minecraftmodded:dead_pressure_plate")
	public static final Block block = null;
	public DeadPressurePlateBlock(MinecraftmoddedModElements instance) {
		super(instance, 91);
	}
